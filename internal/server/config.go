...
func LoadServerConfig() (*ServerConfig, error) {
	...
	v.SetDefault("ldap_start_tls", false)
	v.SetDefault("ldap_insecure_skip_verify", false)
	v.SetDefault("ldap_bind_dn", "")
	v.SetDefault("ldap_bind_password", "")
	v.SetDefault("ldap_user_dn_template", "")
	v.SetDefault("ldap_user_base_dn", "")
	v.SetDefault("ldap_user_filter", "(objectClass=person)")
	v.SetDefault("ldap_username_attr", "uid")
	v.SetDefault("ldap_email_attr", "mail")
	v.SetDefault("ldap_display_name_attr", "cn")
	v.SetDefault("ldap_group_base_dn", "")
	v.SetDefault("ldap_group_filter", "(objectClass=groupOfNames)")
	v.SetDefault("ldap_group_attr", "member")
	v.SetDefault("ldap_role_mapping", map[string][]string{})
	v.SetDefault("ldap_default_roles", []string{})
	v.SetDefault("ldap_to_lower_username", false)

	v.SetDefault("auth_path", "/auth")
	v.SetDefault("auth_logout_path", "/auth/logout")
