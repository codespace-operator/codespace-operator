...
if v := req.Header.Get("Authorization"); v != "" { return metadata.Pairs("authorization", v) }
return nil
}))
conn, err := grpc.DialContext(ctx, grpcAddr, grpc.WithTransportCredentials(insecure.NewCredentials()))
if err != nil { return err }
if err := codespacev1.RegisterSessionServiceHandler(ctx, mux, conn); err != nil { return err }
